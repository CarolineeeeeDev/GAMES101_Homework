...
{   
    ...
    const Eigen::Vector2f A = _v[0].head(2), B = _v[1].head(2), C = _v[2].head(2);//get x and y
    ...
    float eq1 = AP[0] * AB[1] - AP[1] * AB[0];
    float eq2 = BP[0] * BC[1] - BP[1] * BC[0];
    float eq3 = CP[0] * CA[1] - CP[1] * CA[0];
